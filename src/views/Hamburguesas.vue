<template>
  <q-page class="bg-grey-1 hamburguesas-page">
    ...
    <q-header elevated class="bg-dark text-white">
      <q-toolbar class="nav-toolbar">
        ...
        <q-btn flat no-caps label="Hamburguesas" to="/hamburguesas" class="active-nav-btn" />
    ...
    <div class="banner">
      <img
        src="../img/hamburguesas/hamburguesa1.png"
        alt="Hamburguesas Barrio Fast"
      >
      <div class="banner-overlay"></div>
      <div class="banner-text">
        <div class="badge-banner q-mb-sm">
          <q-icon name="lunch_dining" class="q-mr-xs" /> Hamburguesas Artesanales
        </div>
        <h1 class="text-h2 text-weight-bolder q-ma-none banner-title">
          Hamburguesas Gourmet
        </h1>
        <p class="text-subtitle1 banner-subtitle q-mt-sm">
          Preparadas al instante con carne 100% de res, pan brioche recién horneado y salsas de la casa.
        </p>
      </div>
    </div>
        ...
        <div class="row items-center no-wrap-md">
          ...
          <div class="col-12 col-md-7 chef-info q-pa-lg q-pa-md-xl">
            ...
            <div class="text-h4 text-weight-bolder text-dark q-mb-sm chef-title">
              Hamburguesa Barrio Fast
            </div>

            <p class="chef-desc text-body1 text-grey-8">
              180g de carne de res prémium asada al carbón, doble queso cheddar fundido, tocineta crocante, cebolla caramelizada, lechuga fresca, tomate y nuestra salsa secreta en pan artesanal.
            </p>
            ...
            <div class="row items-center justify-between q-mt-lg">
              ...
              <q-btn
                ...
                @click="addToCart({ name: 'Hamburguesa Barrio Fast', price: 24500 })"
              />
            </div>
          </div>
      ...
      <div class="section-header row items-center justify-between q-mb-lg">
        <div>
          ...
          <p class="text-grey-7 text-body2 q-mt-xs q-mb-none">
            Elige tu favorita servida con ingredientes frescos y papas crujientes
          </p>
        </div>
...
import burger1 from '../img/hamburguesas/hamburguesa1.png'
import burger2 from '../img/hamburguesas/hamburguesa2.png'
import burger3 from '../img/hamburguesas/hamburguesa3.png'
import burger4 from '../img/hamburguesas/hamburguesa4.png'
import burger5 from '../img/hamburguesas/hamburguesa5.png'
...
const categories = [
  { id: 'todas', label: 'Todas', icon: 'lunch_dining' },
  { id: 'clasicas', label: 'Clásicas', icon: 'thumb_up' },
  { id: 'especiales', label: 'Especiales', icon: 'whatshot' },
...
const burgers = ref([
  {
    ...
    category: 'clasicas',
    subtitle: '100% Res • 150g',
    desc: 'Carne de res jugosa, queso mozzarella, lechuga fresca, tomate, cebolla morada y salsa de la casa en pan brioche.',
    price: 18500,
    img: burger3,
    tag: 'Más pedido',
    tagColor: 'orange-9',
  ...
  },
  {
    ...
    category: 'especiales',
    subtitle: 'Picante gourmet • 160g',
    desc: 'Carne de res sazonada, queso cheddar, jalapeños en rodajas, guacamole fresco, tomate y salsa picante especial.',
    price: 22000,
    img: burger4,
    tag: 'Picante',
    tagColor: 'red-8',
  ...
  },
  {
    ...
    category: 'especiales',
    subtitle: 'Sabor ahumado • 180g',
    desc: 'Carne de res jugosa, abundante tocino ahumado crujiente, queso cheddar, cebolla caramelizada y generosa salsa BBQ.',
    price: 23500,
    img: burger5,
    tag: 'Nuevo',
    tagColor: 'green-8',
  ...
  },
  {
    ...
    category: 'veggie',
    subtitle: 'Opción Vegetariana • 150g',
    desc: 'Medallón vegetal artesanal de lentejas y champiñones, lechuga, tomate, aguacate cremoso y mayonesa vegana.',
    price: 20000,
    img: burger1,
    tag: 'Vegetariano',
    tagColor: 'teal-8',
...
const filteredBurgers = computed(() => {
  if (selectedCategory.value === 'todas') return burgers.value
  return burgers.value.filter(b => b.category === selectedCategory.value)
})
