<template>
  <q-page class="bg-grey-1 promociones-page">
    ...
    <q-header elevated class="bg-dark text-white">
      <q-toolbar class="nav-toolbar">
        ...
        <q-btn flat no-caps label="Promociones" to="/" class="active-nav-btn" />
    ...
    <div class="banner">
      <img
        src="../img/promociones/promocion1.png"
        alt="Promociones Barrio Fast"
      >
      <div class="banner-overlay"></div>
      <div class="banner-text">
        <div class="badge-banner q-mb-sm">
          <q-icon name="local_offer" class="q-mr-xs" /> Ofertas Especiales
        </div>
        ...
        <p class="text-subtitle1 banner-subtitle q-mt-sm">
          Más sabor por menos: aprovecha nuestros combos especiales y descuentos de la semana.
        </p>
      </div>
    </div>
        ...
        <div class="row items-center no-wrap-md">
          ...
          <div class="col-12 col-md-5">
            <div class="chef-img-wrapper">
              <q-img
                :src="promo2"
                alt="Combo Familiar Barrio Fast"
                fit="contain"
                class="chef-img"
              />
              <div class="chef-float-badge">
                <q-icon name="whatshot" color="red" size="18px" class="q-mr-xs" />
                MEGA OFERTA
              </div>
            </div>
          </div>
          ...
          <div class="col-12 col-md-7 chef-info q-pa-lg q-pa-md-xl">
            <div class="chef-tag row items-center q-gutter-x-xs text-orange-9 text-weight-bold text-uppercase q-mb-xs">
              ...
              <span>Promo Estrella de la Semana</span>
            </div>

            <div class="text-h4 text-weight-bolder text-dark q-mb-sm chef-title">
              Super Combo Barrio Fast
            </div>

            <p class="chef-desc text-body1 text-grey-8">
              Hamburguesa clásica con tocineta + Perro caliente especial + Porción grande de papas a la francesa crujientes + 2 bebidas gaseosas frías de 400 ml.
            </p>

            <div class="row items-center justify-between q-mt-lg">
              <div>
                <span class="text-caption text-grey-6 text-uppercase text-decoration-line-through">Antes $46.000</span>
              ...
              <q-btn
                ...
                @click="addToCart({ name: 'Super Combo Barrio Fast', price: 34900 })"
              />
            </div>
          </div>
      ...
      <div class="section-header row items-center justify-between q-mb-lg">
        <div>
          ...
          <p class="text-grey-7 text-body2 q-mt-xs q-mb-none">
            Combos completos para compartir y ahorrar en cada pedido
          </p>
        </div>
          ...
          <q-card class="product-card shadow-2 column justify-between">
            ...
            <q-card-section class="card-body col column justify-between">
              ...
              <div class="card-footer row items-center justify-between q-pt-md">
                <div class="price-box">
                  <div class="old-price text-caption text-grey-6 text-strike" v-if="item.oldPrice">
...
import promo1 from '../img/promociones/promocion1.png'
import promo2 from '../img/promociones/promocion2.png'
import promo3 from '../img/promociones/promocion3.png'
...
const categories = [
  { id: 'todas', label: 'Todas', icon: 'local_offer' },
  { id: 'combos', label: 'Combos', icon: 'fastfood' },
  { id: '2x1', label: '2x1', icon: 'looks_two' }
]
...
const promos = ref([
  {
    ...
    category: 'combos',
    subtitle: 'Hamburguesa + Papas + Bebida',
    desc: 'Hamburguesa de res artesanal con queso derretido, acompañada de papas francesas doradas y gaseosa personal de 400 ml.',
    price: 21600,
    oldPrice: 27000,
    img: promo2,
    tag: '20% OFF',
  ...
  },
  {
    ...
    category: '2x1',
    subtitle: '2 Pizzas Medianas (16 Porciones)',
    desc: 'Compra una pizza mediana de cualquier sabor (Pepperoni, Margarita o Vegetariana) y recibe otra pizza mediana gratis.',
    price: 30000,
    oldPrice: 54000,
    img: promo1,
    tag: '2x1 Exclusivo',
  ...
  {
    id: 3,
    name: 'Combo Dulce Tentación',
    category: 'combos',
    subtitle: 'Brownie + Helado + Malteada',
    desc: 'Brownie caliente con salsa fudge de chocolate, helado de vainilla y una malteada grande de chocolate con crema chantilly.',
    price: 18000,
    oldPrice: 22500,
    img: promo3,
    tag: 'Combo Dulce',
  ...
  {
    id: 4,
    name: 'Combo Perro Especial + Bebida',
    category: 'combos',
    subtitle: 'Perro + Papas + Jugo Natural',
    desc: 'Perro caliente especial con tocineta y queso, papas francesas crocantes y vaso de limonada natural de 16 oz.',
    price: 19500,
    oldPrice: 24000,
    img: promo2,
    tag: 'Ahorro',
...
const filteredPromos = computed(() => {
  if (selectedCategory.value === 'todas') return promos.value
  return promos.value.filter(p => p.category === selectedCategory.value)
})
...
.old-price { font-size: 0.8rem; margin-bottom: 2px; text-decoration: line-through; } 
.price-caption {
  font-size: 0.75rem;
  line-height: 1;
  text-transform: uppercase;
