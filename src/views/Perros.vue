<template>
  <q-page class="bg-grey-1 perros-page">
    ...
    <q-header elevated class="bg-dark text-white">
      <q-toolbar class="nav-toolbar">
        ...
        <q-btn flat no-caps label="Perros" to="/perros" class="active-nav-btn" />
    ...
    <div class="banner">
      <img
        src="../img/perros/perro2.png"
        alt="Perros Calientes Barrio Fast"
      >
      <div class="banner-overlay"></div>
      <div class="banner-text">
        <div class="badge-banner q-mb-sm">
          <q-icon name="fastfood" class="q-mr-xs" /> Perros Calientes
        </div>
        <h1 class="text-h2 text-weight-bolder q-ma-none banner-title">
          Hot Dogs Especiales
        </h1>
        <p class="text-subtitle1 banner-subtitle q-mt-sm">
          Salchichas prémium, queso derretido, tocineta crocante y salsas artesanales únicas.
        </p>
      </div>
    </div>
        ...
        <div class="row items-center no-wrap-md">
          ...
          <div class="col-12 col-md-7 chef-info q-pa-lg q-pa-md-xl">
            ...
            <p class="chef-desc text-body1 text-grey-8">
              Salchicha americana gigante, queso mozzarella fundido, trocitos de tocineta ahumada crujiente, cebolla caramelizada, ripio de papa y nuestra combinación exclusiva de salsas.
            </p>
            ...
            <div class="row items-center justify-between q-mt-lg">
              ...
              <q-btn
                ...
                @click="addToCart({ name: 'Perro Barrio Fast', price: 18500 })"
              />
            </div>
          </div>
      ...
      <div class="section-header row items-center justify-between q-mb-lg">
        <div>
          ...
          <p class="text-grey-7 text-body2 q-mt-xs q-mb-none">
            Preparados al momento con ingredientes seleccionados de primera calidad
          </p>
        </div>
...
import perro1 from '../img/perros/perro1.png'
import perro2 from '../img/perros/perro2.png'
import perro3 from '../img/perros/perro3.png'
import perro4 from '../img/perros/perro4.png'
import perro5 from '../img/perros/perro5.png'
...
const categories = [
  { id: 'todas', label: 'Todos', icon: 'fastfood' },
  { id: 'clasicos', label: 'Clásicos', icon: 'thumb_up' },
...
const hotDogs = ref([
  {
    ...
    name: 'Perro Clásico',
    category: 'clasicos',
    subtitle: 'Tradicional • Salchicha Prémium',
    desc: 'Salchicha seleccionada, queso derretido, cebolla finamente picada, papa ripio crocante y salsas de la casa.',
    price: 13500,
    img: perro1,
    tag: 'Clásico',
    tagColor: 'grey-9',
  ...
  },
  {
    ...
    name: 'Perro Mexicano',
    category: 'especiales',
    subtitle: 'Toque Picante • Guacamole Fresco',
    desc: 'Salchicha tipo Frankfurt, jalapeños encurtidos, guacamole cremoso, queso fundido y salsa picante.',
    price: 16500,
    img: perro3,
    tag: 'Picante',
    tagColor: 'red-8',
  ...
  {
    id: 3,
    name: 'Perro Especial Tocino',
    category: 'especiales',
    subtitle: 'Extra Queso & Tocineta',
    desc: 'Salchicha prémium, doble porción de tocineta crocante, queso mozzarella fundido, ripio de papa y salsas.',
    price: 17500,
    img: perro4,
    tag: 'Más pedido',
    tagColor: 'orange-9',
  ...
  {
    id: 4,
    name: 'Perro BBQ Caramel',
    category: 'especiales',
    subtitle: 'Salsa Ahumada BBQ',
    desc: 'Salchicha jugosa, queso mozzarella, cebolla caramelizada lentamente, trocitos de tocineta y salsa BBQ.',
    price: 17000,
    img: perro5,
    tag: 'Nuevo',
    tagColor: 'green-8',
...
const filteredHotDogs = computed(() => {
  if (selectedCategory.value === 'todas') return hotDogs.value
  return hotDogs.value.filter(d => d.category === selectedCategory.value)
})
